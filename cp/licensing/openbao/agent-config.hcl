# OpenBao Agent Configuration for CP Licensing
...
# Dynamic credentials snapshot for debugging
template {
...
template {
  source      = "/openbao/templates/cp-licensing.env.tpl"
