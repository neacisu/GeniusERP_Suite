# OpenBao Agent Configuration for CP Identity
...
# Persist dynamic database credentials for troubleshooting
template {
...
# Persist static KV secrets for troubleshooting
template {
...
# Render the runtime .env file and start the Process Supervisor script
template {
  source      = "/openbao/templates/cp-identity.env.tpl"
