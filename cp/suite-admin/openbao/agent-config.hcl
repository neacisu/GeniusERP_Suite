# OpenBao Agent Configuration for CP Suite Admin
...
# Persist KV payload for troubleshooting
template {
...
# Persist static secrets snapshot
template {
...
# Render runtime .env and start Process Supervisor
template {
  source      = "/openbao/templates/cp-suite-admin.env.tpl"
