# OpenBao Agent Configuration for CP Analytics Hub
...
# Capture dynamic DB credentials
template {
...
# Render runtime .env and launch service
template {
  source      = "/openbao/templates/cp-analytics-hub.env.tpl"
