# OpenBao Agent Configuration for Numeriqo Application
...
# Template for combined .env file (optional, for legacy compatibility)
template {
  source      = "/openbao/templates/numeriqo.env.tpl"
