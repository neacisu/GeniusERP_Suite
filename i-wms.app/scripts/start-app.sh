#!/bin/sh
#
# start-app.sh - Process Supervisor entrypoint for i-wms
# Launched by OpenBao Agent after secrets are rendered
#
set -e

echo "[Process Supervisor] Starting i-wms application..."
