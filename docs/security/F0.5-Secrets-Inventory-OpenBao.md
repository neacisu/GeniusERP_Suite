...
| Variable | Type | OpenBao Path | Dynamic? |
|----------|------|--------------|----------|
| `PROXY_DASHBOARD_PASS` | SECRET | `kv/data/infrastructure/proxy/dashboard-pass` | ❌ Static KV |
| `PROXY_CF_API_TOKEN` | SECRET | `kv/data/infrastructure/proxy/cloudflare-token` | ❌ Static KV |
