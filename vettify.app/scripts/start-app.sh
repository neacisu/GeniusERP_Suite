#!/bin/sh
#
# start-app.sh - Process Supervisor entrypoint for vettify
# Launched by OpenBao Agent after secrets are rendered
#
set -e

echo "[Process Supervisor] Starting vettify application..."
