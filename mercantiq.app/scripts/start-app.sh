#!/bin/sh
#
# start-app.sh - Process Supervisor entrypoint for mercantiq
# Launched by OpenBao Agent after secrets are rendered
#
set -e

echo "[Process Supervisor] Starting mercantiq application..."
